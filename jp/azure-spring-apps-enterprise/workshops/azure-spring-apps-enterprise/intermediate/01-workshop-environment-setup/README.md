...
3. 上記の手順が成功した場合、Codespaces の VSCode 内でターミナルを開くことができるようになっています。Codespaces の詳細については、[こちら](https://github.com/CodeSpaces)をご参照ください。この Codespaces の環境では、次のソフトウェアがインストールされています。
