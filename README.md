...
```
Please visit [here](https://azure.microsoft.com/en-us/global-infrastructure/services/?products=spring-cloud&regions=all) for all available regions for Azure Spring Cloud.
